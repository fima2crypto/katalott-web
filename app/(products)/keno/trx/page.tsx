...
import { updateKenoTrxStatus, doKenoTrxKq } from "@/app/lib/kenotrx/actions";
    ...
    <div className="flex items-center gap-1 text-xs">
      ...
      <div className="flex flex-wrap gap-0.5">
        {nums.map((n, i) => (
          <span
            key={i}
            className="px-1 py-0.5 bg-blue-100 text-blue-800 rounded text-xs font-mono"
          >
            {n}
          </span>
        ))}
            ...
            <tbody>
              {list.map((row) => {
                ...
                return (
                  ...
                  >
                    <td className="px-2 py-2 border border-gray-200 font-bold text-blue-700">
                      {id}
                    </td>
                    <td className="px-2 py-2 border border-gray-200 text-center whitespace-nowrap">
                      {fmtDate(row.ngay)}
                    </td>
                    <td className="px-2 py-2 border border-gray-200 text-center font-mono">
                      {row.tu_ky?.trim()}
                    </td>
                    ...
                    <td className="px-2 py-2 border border-gray-200">
                      <div className="flex flex-col gap-1 min-w-[80px]">
                        ...
                        {/* Do ket qua */}
                        <form action={doKenoTrxKq.bind(null, id)}>
                          <button
                            type="submit"
