        ...
        <tbody>
          {entries.map(([bac, cnt], idx) => {
            ...
            return (
              ...
              >
                <Td
                  className={`bg-gray-50 text-gray-500 ${isSelected ? "!bg-blue-100" : ""}`}
                >
                  {idx + 1}
                </Td>
                <Td>
                ...
                <Td
                  className={`font-bold ${isSelected ? "text-blue-700" : ""}`}
                >
                  {cnt}
                </Td>
              </tr>
          ...
          >
            <Td colSpan={2} className="text-right pr-3 font-bold text-gray-600">
              Tổng
            </Td>
        ...
        <div className="text-sm text-gray-500">
          ...
          {selectedBac !== null && (
            <span className="text-blue-600">
              {" "}
              / {data.length} kỳ (Bậc {selectedBac})
            </span>
          )}
